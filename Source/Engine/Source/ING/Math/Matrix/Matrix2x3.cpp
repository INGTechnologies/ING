...
namespace ING {
	...
	namespace Math {
		 ...
		 *	Operators
		 */
		Matrix2x4 Matrix2x3::operator*(Matrix3x4 next) {
		...
		Matrix2x3 Matrix2x3::operator*(Matrix3x3 next) {
		...
		Matrix2x2 Matrix2x3::operator*(Matrix3x2 next) {
		...
		CVector2 Matrix2x3::operator*(CVector3 next) {

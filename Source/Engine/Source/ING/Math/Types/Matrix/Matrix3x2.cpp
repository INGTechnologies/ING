...
namespace ING {
	...
	namespace Math {
		 ...
		 *	Operators
		 */
		Matrix3x4 Matrix3x2::operator*(const Matrix2x4& next) {
		...
		Matrix3x3 Matrix3x2::operator*(const Matrix2x3& next) {
		...
		Matrix3x2 Matrix3x2::operator*(const Matrix2x2& next) {
		...
		CVector3 Matrix3x2::operator*(const CVector2& next) {

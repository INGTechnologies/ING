...
namespace ING {
	...
	namespace StandardRP {
		...
		ING_BEGIN_REFLECTED_CLASS
			(C_DepthPrepass, Rendering::C_Pass)

			ING_CLASS_CONSTRUCTOR
				(C_DepthPrepass, const String&)
		 ...
		 *	Constructor
		 */
		void C_DepthPrepass::Constructor(const String& name) {
		 ...
		 *	Methods
		 */
		bool C_DepthPrepass::Render	(Rendering::IDeviceContext* context, C_Camera* camera) {

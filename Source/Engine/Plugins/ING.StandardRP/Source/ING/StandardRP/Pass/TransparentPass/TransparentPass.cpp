...
namespace ING {
	...
	namespace StandardRP {
		...
		ING_BEGIN_REFLECTED_CLASS
			(C_TransparentPass, Rendering::C_Pass)

			ING_CLASS_CONSTRUCTOR
				(C_TransparentPass, const String&)
		 ...
		 *	Constructor
		 */
		void C_TransparentPass::Constructor(const String& name) {
		 ...
		 *	Release Methods
		 */
		void C_TransparentPass::Release() {
		 ...
		 *	Methods
		 */
		bool C_TransparentPass::Render	(Rendering::IDeviceContext* context, C_Camera* camera) {

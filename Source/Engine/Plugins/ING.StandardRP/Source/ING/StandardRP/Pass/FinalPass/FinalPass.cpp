...
namespace ING {
	...
	namespace StandardRP {
		...
		ING_BEGIN_REFLECTED_CLASS
			(C_FinalPass, Rendering::C_Pass)

			ING_CLASS_CONSTRUCTOR
				(C_FinalPass, const String&)
		 ...
		 *	Constructor
		 */
		void C_FinalPass::Constructor(const String& name) {
		 ...
		 *	Methods
		 */
		bool C_FinalPass::Render	(Rendering::IDeviceContext* context, C_Camera* camera) {

...
namespace ING {
	...
	namespace AMath {
		...
		public:
			...
			inline Vector3(const Vector3& a) : m128(a.m128) {}

			inline Vector3(__m128 m) : m128(m) {}

			Vector3(const Math::Vector3& m);
		...
		static inline Vector3 operator+(const Vector3& a, const Vector3& b)	{ return _mm_add_ps(a.m128, b.m128); }

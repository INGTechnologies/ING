...
namespace ING {
	...
	namespace Math {
		...
		Matrix2x4 Matrix2x4::operator*(Matrix4x4 next) {
		...
		Matrix2x3 Matrix2x4::operator*(Matrix4x3 next) {
		...
		Matrix2x2 Matrix2x4::operator*(Matrix4x2 next) {
		...
		CVector2 Matrix2x4::operator*(CVector4 next) {

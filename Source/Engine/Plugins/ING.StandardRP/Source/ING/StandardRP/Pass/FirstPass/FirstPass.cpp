...
namespace ING {
	...
	namespace StandardRP {
		...
		ING_BEGIN_REFLECTED_CLASS
			(C_FirstPass, Rendering::C_Pass)

			ING_CLASS_CONSTRUCTOR
				(C_FirstPass, const String&)
		 ...
		 *	Constructor
		 */
		void C_FirstPass::Constructor(const String& name) {
		 ...
		 *	Methods
		 */
		bool C_FirstPass::Render	(Rendering::IDeviceContext* context, C_Camera* camera) {

...
namespace ING {
	...
	namespace AMath {
		...
		static inline Matrix4x4 operator * (const Matrix4x4& a, const Matrix4x4& b) { return a * b.ToCMatrix(); }

		static inline Matrix4x4 operator * (const CMatrix4x4& a, const Matrix4x4& b) { return a.ToRMatrix() * b.ToCMatrix(); }

		static inline Matrix4x4 operator * (const CMatrix4x4& a, const CMatrix4x4& b) { return a.ToRMatrix() * b; }



		static const __m256i M4X4_MUL_CM4X3_PERMUTE_1 = _mm256_set_epi32(3, 2, 1, 0, 7, 6, 5, 4);
		static const __m256i M4X4_MUL_CM4X3_PERMUTE_2 = _mm256_set_epi32(5, 7, 4, 6, 3, 1, 2, 0);

		static inline Matrix4x3 operator * (const Matrix4x4& a, const CMatrix4x3& b) {

			__m256 m256_3 = _mm256_permutevar8x32_ps(b.m256_1, M4X4_MUL_CM4X3_PERMUTE_1);
			__m256 m256_4 = _mm256_permutevar8x32_ps(b.m256_2, M4X4_MUL_CM4X3_PERMUTE_1);
			...
			return Matrix4x3(
				_mm256_permutevar8x32_ps(l1, M4X4_MUL_CM4X3_PERMUTE_2),
				_mm256_permutevar8x32_ps(l2, M4X4_MUL_CM4X3_PERMUTE_2)
			);
		}

		static inline Matrix4x3 operator * (const Matrix4x4& a, const Matrix4x3& b) { return a * b.ToCMatrix(); }

		static inline Matrix4x3 operator * (const CMatrix4x4& a, const Matrix4x3& b) { return a.ToRMatrix() * b.ToCMatrix(); }

		static inline Matrix4x3 operator * (const CMatrix4x4& a, const CMatrix4x3& b) { return a.ToRMatrix() * b; }



		static const __m256i M4X4_MUL_CM4X2_PERMUTE_1 = _mm256_set_epi32(3, 2, 1, 0, 7, 6, 5, 4);
		static const __m256i M4X4_MUL_CM4X2_PERMUTE_2 = _mm256_set_epi32(6, 7, 3, 2, 4, 5, 1, 0);

		static inline Matrix4x2 operator * (const Matrix4x4& a, const CMatrix4x2& b) {

			__m256 m256_3 = _mm256_permutevar8x32_ps(b.m256, M4X4_MUL_CM4X2_PERMUTE_1);
			...
			return _mm256_permutevar8x32_ps(l1, M4X4_MUL_CM4X2_PERMUTE_2);
		}

		static inline Matrix4x2 operator * (const Matrix4x4& a, const Matrix4x2& b) { return a * b.ToCMatrix(); }

		static inline Matrix4x2 operator * (const CMatrix4x4& a, const Matrix4x2& b) { return a.ToRMatrix() * b.ToCMatrix(); }

		static inline Matrix4x2 operator * (const CMatrix4x4& a, const CMatrix4x2& b) { return a.ToRMatrix() * b; }
#else

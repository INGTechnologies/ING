...
namespace ING {
	...
	namespace AMath {
		...
		static inline Matrix4x3 operator * (const Matrix4x4& a, const Matrix4x3& b);

		static inline Matrix4x3 operator * (const CMatrix4x4& a, const Matrix4x3& b);

		static inline Matrix4x3 operator * (const CMatrix4x4& a, const CMatrix4x3& b);



		static inline Matrix4x2 operator * (const Matrix4x4& a, const CMatrix4x2& b);

		static inline Matrix4x2 operator * (const Matrix4x4& a, const Matrix4x2& b);

		static inline Matrix4x2 operator * (const CMatrix4x4& a, const Matrix4x2& b);

		static inline Matrix4x2 operator * (const CMatrix4x4& a, const CMatrix4x2& b);
#else

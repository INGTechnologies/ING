...
namespace ING {
	...
	namespace StandardRP {
		...
		ING_BEGIN_REFLECTED_CLASS
			(C_SkyPass, Rendering::C_Pass)

			ING_CLASS_CONSTRUCTOR
				(C_SkyPass, const String&)
		 ...
		 *	Constructor
		 */
		void C_SkyPass::Constructor(const String& name) {
		 ...
		 *	Methods
		 */
		bool C_SkyPass::Render	(Rendering::IDeviceContext* context, C_Camera* camera) {

...
namespace ING {
	...
	namespace StandardRP {
		...
		ING_BEGIN_REFLECTED_CLASS
			(C_PostProcessPass, Rendering::C_Pass)

			ING_CLASS_CONSTRUCTOR
				(C_PostProcessPass, const String&)
		 ...
		 *	Constructor
		 */
		void C_PostProcessPass::Constructor(const String& name) {
		 ...
		 *	Release Methods
		 */
		void C_PostProcessPass::Release() {
		 ...
		 *	Methods
		 */
		bool C_PostProcessPass::Render	(Rendering::IDeviceContext* context, C_Camera* camera) {

...
namespace ING {
	...
	namespace StandardRP {
		...
		ING_BEGIN_REFLECTED_CLASS
			(C_GBufferPass, Rendering::C_Pass)

			ING_CLASS_CONSTRUCTOR
				(C_GBufferPass, const String&)
		 ...
		 *	Constructor
		 */
		void C_GBufferPass::Constructor(const String& name) {
		 ...
		 *	Methods
		 */
		bool C_GBufferPass::Render	(Rendering::IDeviceContext* context, C_Camera* camera) {

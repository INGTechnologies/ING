...
namespace ING {
	...
	namespace Rendering {
		 ...
		 *	Create Methods
		 */
		IPixelShader* IPixelShader::CreateFromHLSL(IDevice* device, const WString& filePath) {
		...
		IPixelShader* IPixelShader::CreateFromHLSL(const WString& filePath) {
		 ...
		 *	Methods
		 */
		void IPixelShader::Apply(const String& name) {

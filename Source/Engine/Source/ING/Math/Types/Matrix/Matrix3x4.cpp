...
namespace ING {
	...
	namespace Math {
		 ...
		 *	Operators
		 */
		Matrix3x4 Matrix3x4::operator*(const Matrix4x4& next) {
		...
		Matrix3x3 Matrix3x4::operator*(const Matrix4x3& next) {
		...
		Matrix3x2 Matrix3x4::operator*(const Matrix4x2& next) {
		...
		CVector3 Matrix3x4::operator*(const CVector4& next) {
